...
import { ExamInput, CreateExamOutput, ListExamInput, ListExamOutput, ExamOutput, ReviewExamInput} from './exam.dto';
...
// đánh giá đề thi
async reviewExam(input: ReviewExamInput,currentUser:User): Promise<CoreOutput> {
  try {
